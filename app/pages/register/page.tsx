...
const register = () => {
  ...
  return (
    <main className="flex flex-col md:flex-row">
      ...
      <section className="bg-[url('https://t3.ftcdn.net/jpg/02/10/09/58/360_F_210095815_Bg6E1AVIZIHi4GIm9ydpB2hUDWsHlXBn.jpg')] bg-cover bg-center grid place-items-center order-1 md:order-2 h-1/2 md:h-screen w-screen md:w-1/2 p-8 text-pink-500">
        ...
        <form onSubmit={handleSubmit} className="grid place-items-center gap-2 md:gap-4 w-full">
          ...
          <input type="email" id="email" name="email" required className="text-center focus:border-4 border-2 border-pink-200 rounded-full p-2 w-full max-w-[500px] focus:font-bold bg-transparent"/>
          ...
          <input type="password" id="confirmPassword" name="confirmPassword" required className="text-center focus:border-4 border-2 border-pink-200 rounded-full p-2 w-full max-w-[500px] focus:font-bold bg-transparent"/>
        ...
        <p className="text-center">
          Already have an account? <Link href={"/pages/login"}><b>Sign in</b></Link>
        </p>
      </section>
    </main>
  )
